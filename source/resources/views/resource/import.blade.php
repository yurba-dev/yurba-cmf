...
@section('title', 'Import '.$res->pluralLabel())
@section('heading', 'Import '.$res->pluralLabel())
...
@section('content')
    <form method="POST" action="{{ route('yurba.resource.import.run', $res->uriKey()) }}"
        ...
        <div class="y-field">
            <label>Recognised columns</label>
            <p class="y-help">
        ...
        <div class="y-form__actions">
            <button type="submit" class="y-btn y-btn__primary">Import</button>
